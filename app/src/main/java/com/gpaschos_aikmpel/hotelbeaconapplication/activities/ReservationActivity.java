...
public class ReservationActivity extends AppCompatActivity implements DatePickerFragment.DateSelected, ReservationCallbacks {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigationDrawerReservations:
                    intent = new Intent(ReservationActivity.this, ReservationActivity.class);
                ...
                case R.id.navigationDrawerLogout:
                    RoomDB.getInstance(ReservationActivity.this).clearAllTables();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReservationFragment offerFragment = ReservationFragment.newInstance();
